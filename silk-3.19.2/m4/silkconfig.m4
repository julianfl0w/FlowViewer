dnl Copyright (C) 2004-2022 by Carnegie Mellon University.
dnl
dnl @OPENSOURCE_LICENSE_START@
dnl See license information in ../LICENSE.txt
dnl @OPENSOURCE_LICENSE_END@

dnl RCSIDENT("$SiLK: silkconfig.m4 ba4a308de770 2022-03-02 22:29:28Z mthomas $")
...
AC_DEFUN([SILK_RPM_SPEC_SUBST],[
    ...
    if test "x${PACKING_LOGIC_PATH}" != "x"
    then
        RPM_SPEC_CONFIGURE="${RPM_SPEC_CONFIGURE} --enable-packing-logic=${sk_pack_path}"
    fi

/*
** Copyright (C) 2007-2022 by Carnegie Mellon University.
**
...
#define PY_SSIZE_T_CLEAN 1      /* "s#" "y#" formats must use ssize_t */
#include <Python.h>             /* Must be included before any system
                                   headers */
#include <silk/silk.h>

RCSIDENT("$SiLK: pysilk.c ba4a308de770 2022-03-02 22:29:28Z mthomas $");
